import svgPaths from "./svg-em1t7huqfb";
              ...
              <div className="overflow-clip relative rounded-[4px] shrink-0 size-[32px]" data-name="Button 按钮">
                <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[16px] top-1/2" data-name="Language2=English">
                  <div className="absolute left-[2px] size-[12px] top-[2px]" data-name="Union">
                    <svg className="absolute block inset-0 size-full" fill="none" height="12" preserveAspectRatio="none" viewBox="0 0 12 12" width="12">
                      <path clipRule="evenodd" d={svgPaths.p251bf2f0} fill="#1450F5" fillRule="evenodd" id="Union" />
                    </svg>
                  </div>
                </div>
              </div>
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
      ...
      <div className="bg-[#f3f6fe] relative rounded-[4px] shrink-0 size-[32px]" data-name="Button 按钮">
          ...
          <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 overflow-clip size-[16px] top-1/2" data-name="filter">
            <div className="absolute inset-[12.5%_12.5%_13.88%_12.5%]" data-name="Union">
              <svg className="absolute block inset-0 size-full" fill="none" height="11.779" preserveAspectRatio="none" viewBox="0 0 12 11.779" width="12">
                <path d={svgPaths.p1d949680} fill="#1450F5" id="Union" />
              </svg>
            </div>
          </div>
        </div>
        <div aria-hidden className="absolute border border-[#1450f5] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
      <div className="overflow-clip relative shrink-0 size-[20px]" data-name="icon">
        <div className="absolute inset-[12.5%_12.5%_13.88%_12.5%]" data-name="Union">
          <svg className="absolute block inset-0 size-full" fill="none" height="14.7237" preserveAspectRatio="none" viewBox="0 0 15 14.7237" width="15">
            <path d={svgPaths.p2d1f6e80} fill="#1450F5" id="Union" />
          </svg>
        </div>
      </div>
      <p className="[word-break:break-word] font-['PingFang_SC:Regular',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#141414] text-[14px] whitespace-nowrap">共有**台设备符合筛选结果。</p>
    </div>
  );
}
...
function Alert() {
  return (
    <div className="bg-[#f3f6fe] content-stretch flex items-center justify-between overflow-clip px-[16px] py-[10px] relative rounded-[6px] shrink-0 w-[1118px]" data-name="Alert 警告">
      <Frame7 />
      <div className="relative shrink-0" data-name="Checkbox 多选">
        <div className="content-stretch flex gap-[8px] items-start relative size-full">
          <Checkbox />
          <p className="[word-break:break-word] font-['PingFang_SC:Regular',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#141414] text-[14px] whitespace-nowrap">全部选择</p>
        </div>
      </div>
    </div>
  );
...
function ItemContentColumnHeaderNormalL() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[54px]" data-name="item/content/column header/normal/l">
      <div className="bg-[#f5f7fa] h-[46px] relative shrink-0 w-full" data-name="item/header/select cell/normal">
      ...
      <div className="bg-white h-[54px] relative shrink-0 w-full" data-name="item/content/select cell/normal">
        <div aria-hidden className="absolute border-[#dfe1e8] border-b border-solid inset-0 pointer-events-none" />
        <div className="flex flex-col items-center justify-center size-full">
          <div className="content-stretch flex flex-col items-center justify-center relative size-full">
            <div className="relative shrink-0 size-[16px]" data-name="item/unit/checkbox">
