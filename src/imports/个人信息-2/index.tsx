...
function Header() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="header">
      <p className="[word-break:break-word] flex-[1_0_0] font-['PingFang_SC:Semibold',sans-serif] leading-[22px] min-w-px not-italic relative text-[#141414] text-[14px]">批量升级任务已被批准</p>
    </div>
  );
}
...
function Details() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="details">
      <p className="[word-break:break-word] font-['PingFang_SC:Regular',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#141414] text-[14px] w-full">您发起的7 台设备批量升级，已被系统管理员批准。您可进入任务中心查看执行状态。</p>
    </div>
  );
}
...
function Header1() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="header">
      <p className="[word-break:break-word] flex-[1_0_0] font-['PingFang_SC:Semibold',sans-serif] leading-[22px] min-w-px not-italic relative text-[#141414] text-[14px]">审批请求被驳回</p>
    </div>
  );
}
...
function Details1() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col font-['PingFang_SC:Regular',sans-serif] gap-[4px] items-start leading-[22px] not-italic relative shrink-0 text-[14px] w-full" data-name="details">
      <p className="relative shrink-0 text-[#141414] w-full">您发起的7 台设备批量升级，已被系统管理员驳回。</p>
      <p className="relative shrink-0 text-[#676a72] w-full">备注：不符合升级条件。</p>
    </div>
  );
}
