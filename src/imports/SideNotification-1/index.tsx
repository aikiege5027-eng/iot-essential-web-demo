function Header() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="header">
      <p className="[word-break:break-word] flex-[1_0_0] font-['PingFang_SC:Semibold',sans-serif] leading-[24px] min-w-px not-italic relative text-[#141414] text-[16px]">审批请求被驳回</p>
    </div>
  );
}
