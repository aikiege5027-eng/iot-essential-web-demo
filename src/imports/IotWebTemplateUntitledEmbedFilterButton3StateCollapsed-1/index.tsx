import svgPaths from "./svg-k7keowhjm7";
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
      ...
      <div className="bg-[#f2f4f7] overflow-clip relative rounded-[4px] shrink-0 size-[32px]" data-name="Button 按钮">
      ...
      <div className="relative shrink-0 size-[16px]" data-name="refresh-1">
        <div className="absolute inset-[6.25%]" data-name="Union">
          <svg className="absolute block inset-0 size-full" fill="none" height="14" preserveAspectRatio="none" viewBox="0 0 14 14" width="14">
            <g id="Union">
              <path d={svgPaths.p118f3a80} fill="#141414" />
              <path d={svgPaths.pfc65c00} fill="#141414" />
            </g>
          </svg>
        </div>
      </div>
      <p className="[word-break:break-word] flex-[1_0_0] font-['PingFang_SC:Regular',sans-serif] h-[22px] leading-[22px] min-w-px not-italic overflow-hidden relative text-[#141414] text-[14px] text-ellipsis whitespace-nowrap">重启模块</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[6px] items-center min-w-px relative">
      <div className="relative shrink-0 size-[16px]" data-name="chart-1">
        <div className="absolute inset-[12.5%]" data-name="Union">
          <svg className="absolute block inset-0 size-full" fill="none" height="12" preserveAspectRatio="none" viewBox="0 0 12 12" width="12">
            <path d={svgPaths.p2538db80} fill="#141414" id="Union" />
          </svg>
        </div>
      </div>
      <p className="[word-break:break-word] flex-[1_0_0] font-['PingFang_SC:Regular',sans-serif] h-[22px] leading-[22px] min-w-px not-italic overflow-hidden relative text-[#141414] text-[14px] text-ellipsis whitespace-nowrap">系统升级</p>
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[6px] items-center min-w-px relative">
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="new_release_1">
        <div className="absolute h-[15.437px] left-[1.46px] top-[0.46px] w-[13.073px]" data-name="Union">
          <svg className="absolute block inset-0 size-full" fill="none" height="15.4367" preserveAspectRatio="none" viewBox="0 0 13.0733 15.4367" width="13.0733">
            <g id="Union">
              <path d={svgPaths.p249a2fb0} fill="#141414" />
              <path d={svgPaths.p32af2800} fill="#141414" />
              <path d={svgPaths.p20b73a80} fill="#141414" />
              <path d={svgPaths.p15c9d200} fill="#141414" />
              <path d={svgPaths.p2e4b7980} fill="#141414" />
              <path d={svgPaths.p3988e800} fill="#141414" />
              <path d={svgPaths.p5a3c800} fill="#141414" />
            </g>
          </svg>
        </div>
      </div>
      <p className="[word-break:break-word] flex-[1_0_0] font-['PingFang_SC:Regular',sans-serif] h-[22px] leading-[22px] min-w-px not-italic overflow-hidden relative text-[#141414] text-[14px] text-ellipsis whitespace-nowrap">配置更新</p>
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full">
      <div className="bg-[#f2f4f7] relative rounded-[4px] shrink-0 w-full" data-name="子菜单item">
        <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
...
function Component() {
  return (
    <div className="absolute bg-white content-stretch drop-shadow-[0px_4px_5px_rgba(0,0,0,0.1)] flex flex-col items-start left-[892.58px] px-[6px] py-[8px] rounded-[8px] top-[36.5px] w-[120px]" data-name="批量操作">
      <Frame4 />
    </div>
  );
}
