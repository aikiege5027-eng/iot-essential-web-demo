import svgPaths from "./svg-i9zs753emt";
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[32px] items-center relative shrink-0">
      <Frame2 />
      <div className="flex h-[37px] items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
      ...
      <div className="content-stretch flex flex-col gap-[4px] items-start px-[8px] relative size-full">
        <div className="bg-white relative rounded-[6px] shrink-0 w-full" data-name="item/normalMenu/1st-light">
          <div className="flex flex-row items-center justify-center size-full">
            <div className="content-stretch flex gap-[8px] items-center justify-center px-[16px] py-[7px] relative size-full">
...
export default function IoT() {
  return (
    <div className="bg-[#f5f7fa] relative size-full" data-name="IoT">
      <div className="absolute bottom-[18px] content-stretch flex items-center justify-center p-[16px] right-[24px] w-[1160px]" data-name="footer">
      ...
      <div className="absolute bg-white bottom-0 content-stretch flex flex-col items-start justify-between left-0 overflow-clip pt-[8px] top-[56px] w-[64px]" data-name="Menu 侧边菜单导航">
        <Content1 />
