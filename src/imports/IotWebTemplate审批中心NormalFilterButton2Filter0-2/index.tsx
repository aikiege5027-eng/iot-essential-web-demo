import svgPaths from "./svg-v6lpe57lam";
            ...
            <div className="relative shrink-0" data-name="item/content/state">
              <div className="flex flex-row items-center size-full">
                <div className="content-stretch flex gap-[4px] items-center relative size-full">
                  ...
                  <p className="[word-break:break-word] font-['PingFang_SC:Regular',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#f98600] text-[14px] whitespace-nowrap">待审批</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[24px] items-center px-[24px] py-[16px] relative size-full">
            <div className="relative rounded-[3px] shrink-0" data-name="Link 链接">
              <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
                <div className="content-stretch flex items-center relative size-full">
                  <div className="[word-break:break-word] flex flex-col font-['PingFang_SC:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1450f5] text-[14px] whitespace-nowrap">
