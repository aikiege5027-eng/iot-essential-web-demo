...
function Steps() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-[37px] top-[55px] w-[672px]" data-name="Steps 步骤条">
      <MasterVerticalDot />
      <MasterVerticalDot1 />
    </div>
  );
...
function Steps1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-[37px] top-[251px] w-[672px]" data-name="Steps 步骤条">
      <MasterVerticalDot2 />
      <MasterVerticalDot3 />
    </div>
  );
...
function Steps2() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-[37px] top-[476px] w-[672px]" data-name="Steps 步骤条">
      <MasterVerticalDot4 />
      <MasterVerticalDot5 />
    </div>
  );
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="审批流状态">
      ...
      <Steps1 />
      <Steps2 />
      <p className="[word-break:break-word] absolute font-['PingFang_SC:Regular',sans-serif] leading-[22px] left-[40px] not-italic text-[14px] text-black top-[20px] whitespace-nowrap">待审批</p>
      <p className="[word-break:break-word] absolute font-['PingFang_SC:Regular',sans-serif] leading-[22px] left-[40px] not-italic text-[14px] text-black top-[216px] whitespace-nowrap">驳回</p>
      <p className="[word-break:break-word] absolute font-['PingFang_SC:Regular',sans-serif] leading-[22px] left-[40px] not-italic text-[14px] text-black top-[437px] whitespace-nowrap">批准</p>
      <div className="absolute h-0 left-[36px] top-[187px] w-[680px]">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" height="1" preserveAspectRatio="none" viewBox="0 0 680 1" width="680">
            <line id="Line 257" stroke="black" x2="680" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
      <div className="absolute h-0 left-[36px] top-[433px] w-[690px]">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" height="1" preserveAspectRatio="none" viewBox="0 0 690 1" width="690">
            <line id="Line 258" stroke="black" x2="690" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
    </div>
