import svgPaths from "./svg-oo0m7u4fc5";
...
function Title({ className }: { className?: string }) {
  return (
    <div className={className || "bg-white h-[68px] relative rounded-tl-[6px] rounded-tr-[6px] w-[1160px]"} data-name="Title">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pb-[16px] pt-[24px] px-[20px] relative size-full">
          <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative">
            <p className="[word-break:break-word] font-['PingFang_SC:Semibold',sans-serif] leading-[28px] not-italic relative shrink-0 text-[20px] text-black whitespace-nowrap">页面标题</p>
          </div>
          <div className="absolute content-stretch flex gap-[8px] items-center right-[20.42px] top-[19.5px]">
              ...
              <div className="relative shrink-0 size-[20px]" data-name="prefixIcon">
                <div className="absolute inset-[12.5%]" data-name="Union">
                  <svg className="absolute block inset-0 size-full" fill="none" height="15" preserveAspectRatio="none" viewBox="0 0 15 15" width="15">
                    <path clipRule="evenodd" d={svgPaths.p3b76af00} fill="#727272" fillRule="evenodd" id="Union" />
                  </svg>
                </div>
              </div>
              <p className="[word-break:break-word] flex-[1_0_0] font-['PingFang_SC:Regular',sans-serif] h-[22px] leading-[22px] min-w-px not-italic overflow-hidden relative text-[#727272] text-[14px] text-ellipsis whitespace-nowrap">设备查询</p>
            </div>
          </div>
        </div>
        <div className="bg-white relative rounded-[6px] shrink-0 w-full" data-name="item/normalMenu/1st-light">
  ...
  return (
    <div className="absolute left-[256.42px] rounded-[8px] top-[78.5px] w-[1160px]">
      <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] size-full">
        <Title className="bg-white h-[68px] relative rounded-tl-[6px] rounded-tr-[6px] shrink-0 w-full" />
        <Frame1 />
      </div>
...
export default function PageTypeNormalFilterButton2Filter() {
  return (
    <div className="bg-[#f5f7fa] relative size-full" data-name="Page type=Normal filter;Button=2;Filter=0">
