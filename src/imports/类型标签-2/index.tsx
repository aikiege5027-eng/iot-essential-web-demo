import svgPaths from "./svg-z8xdi7cas6";
type ComponentProps = {
  className?: string;
  prefixIcon?: boolean;
  property1?: "设备注册";
...
function Component({ className, prefixIcon = true, property1 = "设备注册", propValue = "设备", propValue1 = "大" }: ComponentProps) {
  return (
    <div className={className || "bg-[#f5f7fa] relative rounded-[3px]"}>
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[4px] items-center px-[8px] py-[5px] relative size-full">
          ...
          <p className="[word-break:break-word] font-['PingFang_SC:Regular',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#333740] text-[14px] whitespace-nowrap">设备注册</p>
        </div>
      </div>
    </div>
  );
