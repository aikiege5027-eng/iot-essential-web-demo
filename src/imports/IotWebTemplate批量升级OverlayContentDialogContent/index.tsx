import svgPaths from "./svg-uj64kmlbtu";
...
function Component({ className, prefixIcon = true, property1 = "Normal", propValue = false }: ComponentProps) {
  return (
    <div className={className || "bg-white relative rounded-[4px] w-[356px]"}>
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      <Component className="bg-white relative rounded-[4px] shrink-0 w-full" propValue />
      <Component className="bg-white relative rounded-[4px] shrink-0 w-full" propValue />
      <Component className="bg-white relative rounded-[4px] shrink-0 w-full" propValue />
      <Component className="bg-white relative rounded-[4px] shrink-0 w-full" propValue />
      <Component className="bg-white relative rounded-[4px] shrink-0 w-full" propValue />
      <Component className="bg-white relative rounded-[4px] shrink-0 w-full" propValue />
      <Component className="bg-white relative rounded-[4px] shrink-0 w-full" propValue />
      <Component className="bg-white relative rounded-[4px] shrink-0 w-full" />
    </div>
  );
}
