import svgPaths from "./svg-on7ts4i0r6";
...
function Content1() {
  return (
    <div className="bg-white content-stretch flex items-center px-[8px] py-[5px] relative rounded-[3px] shrink-0" data-name="content">
      <p className="[word-break:break-word] font-['PingFang_SC:Regular',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#676a72] text-[14px] whitespace-nowrap">设备批量操作设置</p>
    </div>
  );
}
...
function Content2() {
  return (
    <div className="bg-white content-stretch flex items-center px-[8px] py-[5px] relative rounded-[3px] shrink-0" data-name="content">
      <p className="[word-break:break-word] font-['PingFang_SC:Medium',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#1450f5] text-[14px] whitespace-nowrap">单设备解绑操作审批设置</p>
    </div>
  );
}
    ...
    <div className="bg-white relative rounded-[6px] shrink-0 w-full" data-name="container">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[8px] py-[4px] relative size-full">
          <p className="[word-break:break-word] font-['PingFang_SC:Regular',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#141414] text-[14px] whitespace-nowrap">设备解绑超过设置上限时，将提交至所选角色审批。</p>
        </div>
      </div>
    </div>
  );
      ...
      <div className="bg-white flex-[1_0_0] h-[32px] min-w-px relative rounded-bl-[4px] rounded-tl-[4px] z-[2]" data-name="InputNumber数字输入框">
        <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex gap-[8px] items-center pl-[8px] py-px relative size-full">
            <p className="[word-break:break-word] flex-[1_0_0] font-['PingFang_SC:Regular',sans-serif] h-[22px] leading-[22px] min-w-px not-italic overflow-hidden relative text-[#141414] text-[14px] text-ellipsis whitespace-nowrap">10</p>
            <Controls />
          </div>
        </div>
      ...
      <div className="bg-white flex-[1_0_0] h-[32px] min-w-px relative rounded-bl-[4px] rounded-tl-[4px] z-[2]" data-name="InputNumber数字输入框">
        <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex items-center px-[8px] py-[5px] relative size-full">
            <p className="[word-break:break-word] flex-[1_0_0] font-['PingFang_SC:Regular',sans-serif] h-[22px] leading-[22px] min-w-px not-italic overflow-hidden relative text-[#141414] text-[14px] text-ellipsis whitespace-nowrap">50</p>
          </div>
        </div>
            ...
            <div className="flex flex-row items-center size-full">
              <div className="content-stretch flex gap-[8px] items-center px-[8px] py-[5px] relative size-full">
                <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['PingFang_SC:Regular',sans-serif] h-[22px] justify-center leading-[0] min-w-px not-italic overflow-hidden relative text-[#141414] text-[14px] text-ellipsis whitespace-nowrap">
                  <p className="leading-[22px] overflow-hidden text-ellipsis">L2</p>
                </div>
...
function Container1() {
  return (
    <div className="bg-white relative rounded-[6px] shrink-0 w-full" data-name="container">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[8px] py-[4px] relative size-full">
          <p className="[word-break:break-word] font-['PingFang_SC:Regular',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#141414] text-[14px] whitespace-nowrap">平台内用户在 7 个自然日内解绑设备数量超过该值后，该周期内后续解绑操作均需要审批。</p>
        </div>
      </div>
    </div>
  );
...
function Container3() {
  return (
    <div className="bg-white relative rounded-[6px] shrink-0 w-full" data-name="container">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[8px] py-[4px] relative size-full">
          <p className="[word-break:break-word] font-['PingFang_SC:Regular',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#141414] text-[14px] whitespace-nowrap">平台内用户在 1 个自然日内解绑设备数量超过该值后，当日后续解绑操作均需要审批。</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative shrink-0 w-full" data-name="Container:margin">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col items-center pb-[26px] px-[16px] relative size-full">
          <Frame2 />
          <div className="absolute drop-shadow-[0px_4px_5px_rgba(0,0,0,0.1)] left-[185.58px] top-[137.5px]" data-name="维保合同无效（已编排）">
            <div className="content-stretch flex flex-col items-start relative size-full">
              <Container1 />
              <Arrow1 />
            </div>
          ...
          <Container2 />
          <div className="absolute drop-shadow-[0px_4px_5px_rgba(0,0,0,0.1)] left-[158.58px] top-[48.5px]" data-name="维保合同无效（已编排）">
            <div className="content-stretch flex flex-col items-start relative size-full">
              <Container3 />
              <Arrow2 />
            </div>
  ...
  return (
    <div className="bg-white relative rounded-bl-[6px] rounded-br-[6px] shrink-0 w-full">
      <div className="content-stretch flex flex-col gap-[24px] items-start px-[20px] py-[2px] relative size-full">
        ...
        <div className="absolute drop-shadow-[0px_4px_5px_rgba(0,0,0,0.1)] left-[256.58px] top-[37.5px]" data-name="维保合同无效（已编排）">
          <div className="content-stretch flex flex-col items-start relative size-full">
            <Container />
            <Arrow />
          </div>
