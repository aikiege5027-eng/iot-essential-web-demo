import svgPaths from "./svg-u9vlp5d0rg";
...
function Frame7() {
  return (
    <div className="content-stretch flex gap-[11px] items-end relative shrink-0 w-full">
      <p className="[word-break:break-word] font-['PingFang_SC:Semibold',sans-serif] leading-[32px] not-italic relative shrink-0 text-[#141414] text-[24px] whitespace-nowrap">任务进度视图</p>
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[256px] top-[80px] w-[1160px]">
      <Frame7 />
      <Frame12 />
    </div>
  );
